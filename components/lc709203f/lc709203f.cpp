 ...
 *     v1.0 - First release
 *
 *  extended for esphome driver see https://github.com/EzSBC/ESP32_Bat_Pro
 *  added code to allow inclusion as new component in esphome 
 *  modelled on esphome github component ads1115 and others
 *
 */
